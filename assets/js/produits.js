// Base URL for images
// const imageBaseUrl = 'https://monsite.com/';

const imageBaseUrl = 'https://gmh.free.nf/assets/images/demos/demo-4/products/tout'; // Remplacez par l'URL où vos images sont hébergées
...
function redirectToWhatsApp(item) {
    ...
    \nImage: ${item.image}`;
    const whatsappUrl = `https://wa.me/+2250706841082?text=${encodeURIComponent(message)}`;
