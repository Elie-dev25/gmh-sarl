...
<!-- GM&H/index-4.php  04 jul 2024 09:53:08 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>GM&H-General Market and Healthcare</title>
...
<!-- Bootstrap CSS -->
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6gy4IcvqqNEVA4nRFntJM3moqZjwFjGz/th17CQ" crossorigin="anonymous">
                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li> <a href="<?php echo isset($_SESSION['email']) ? 'account.php' : 'login.html'; ?>">Compte</a></li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                ...
                <div class="container">
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="index-4.php#new-phones-tab" class="nav-category">Informatique</a></li>
                                        <!-- <li><a href="#new-all-link">Communication</a></li> -->
                                        <li><a href="index-4.php#new-tv-tab" class="nav-category">Healthcare</a></li>
                                        <li><a href="index-4.php#new-acc-tab" class="nav-category">Sauvegarde</a></li>
                                        <li><a href="index-4.php#new-watches-tab" class="nav-category">Securité</a></li>
                                        <li><a href="index-4.php#new-computers-tab" class="nav-category">Infracstructure</a></li>
                                ...
                                <li>
                                    <a href="cathalogue.php">catalogue</a>
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="panier.php" class="dropdown-toggle" >
                                <i href="panier.php"  class="icon-shopping-cart"></i>
                                <span class="cart-count" >0</span>
                            </a>
                            <div id="cart-dropdown" class="cart-dropdown-content">
                                <!-- Les produits ajoutés récemment seront affichés ici -->
                            </div>
        ...
        <main class="main">
            <div class="intro-slider-container">
                <div class="intro-slider owl-carousel owl-simple owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{"nav":false, "dots": false, "loop": false}'>
                    <div class="intro-slide" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/acceuil.jpg');">
                        <div class="container intro-content text-center">
                            <h1 class="intro-title text-white">Bienvenue chez General Market and Healthcare</h1><!-- End .intro-title -->
                            <h3 class="intro-subtitle">Vous pouvez directement nous</h3><!-- End .h3 intro-subtitle -->

                            <a href="contact.html" class="btn btn-outline-white" style="background-color: #2F83C2; border-radius: 10px; border: #2F83C2;">
                                <span>CONTACTER</span>
            ...
            <div class="container" style="height: auto;">
                <div class="row">
                    <div class="col-md-6">
                        <div class="banner banner-display banner-link-anim banner-title-hidden new-class">
                            <a href="#">
                                <img src="images/service.png" alt="Banner">
                            </a>

                            <div class="banner-content banner-content-center">
                                <h3 class="banner-title text-white"><a href="blog-listing.html">Nos service</a></h3><!-- End .banner-title -->
                                <a href="blog-listing.html" class="btn btn-outline-white banner-link">consulter</a>
                            </div><!-- End .banner-content -->
                        </div><!-- End .banner -->
                    </div><!-- End .col-md-6 -->
                    ...
                    <div class="col-md-6">
                        <div class="banner banner-display banner-link-anim banner-title-hidden">
                            <a href="#">
                                <img src="images/healthcare.png" alt="Banner">
                            </a>

                            <div class="banner-content banner-content-center">
                                <h3 class="banner-title text-white"><a href="index-4.php#new-tv-tab" >Healthcare solutions</a></h3><!-- End .banner-title -->
                                <a href="index-4.php#new-tv-tab" class="btn btn-outline-white banner-link">Decouvrir</a>
                            </div><!-- End .banner-content -->
                        </div><!-- End .banner -->
                        <div class="banner banner-display banner-link-anim banner-title-hidden" style="max-height: 150px;">
                            <a href="#">
                                <img src="images/general1.jpg" alt="Banner">
                            </a>

                            <div class="banner-content banner-content-center">
                                <h3 class="banner-title text-white"><a href="index-4.php#new-all-tab">General market</a></h3><!-- End .banner-title -->
                                <a href="index-4.php#new-all-tab" class="btn btn-outline-white banner-link">Decouvrir</a>
                            </div><!-- End .banner-content -->
                        </div><!-- End .banner -->
                    </div><!-- End .col-md-6 -->
                </div><!-- End .row -->
            ...
            <section class="about-section">
                ...
                <div class="about-container">
                    <div class="about-text" style="font-size: 15px!important;">
                        ...
                        <a href="about.php">Voir plus</a>
                    </div>
                    <div class="about-image">
                        <img src="images/propos.png" alt="À propos de nous">
                    </div>
                </div>
            </section>
            ...
            <section class="services-section">
                ...
                <div class="services-container">
                    <a href="#" class="service-item">
                        ...
                        <p>Service de soins de santé pour tous.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>IMPRIMERIE</h3>
                        <img src="images/imprimerie.png" alt="Imprimerie">
                        <p>Services d'impression de haute qualité.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>MATERIELS & MAINTENANCE</h3>
                        <img src="images/industriel.png" alt="Matériels & Maintenance">
                        <p>Fourniture et maintenance de matériels.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>réseaux</h3>
                        <img src="images/reseau.png" alt="Réseaux">
                        <p>Solutions de réseau fiables et sécurisées.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>MATERIELS INFORMATIQUES</h3>
                        <img src="images/informatique.png" alt="Matériels Informatiques">
                        <p>Équipements informatiques de pointe.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>SECURITE RESEAU</h3>
                        <img src="images/Securite.png" alt="Sécurité Réseau">
                        <p>Protection avancée pour vos réseaux.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>TELEPHONIE IP</h3>
                        <img src="images/telephonie.png" alt="Téléphonie IP">
                        <p>Solutions de téléphonie IP modernes.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>RADIO COMMUNICATION</h3>
                        <img src="images/Radio.png" alt="Radio Communication">
                        <p>Services de communication par radio.</p>
                    </a>
                    <a href="#"  class="service-item">
                        <h3>VIRTUALISATION DES RESSOURCES</h3>
                        <img src="images/virtualisation.png" alt="Virtualisation des Ressources">
                        <p>Optimisation des ressources virtuelles.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>SAUVEGARDE DES DONNEES</h3>
                        <img src="images/sauvegarde.png" alt="Sauvegarde des Données">
                        <p>Solutions de sauvegarde sécurisées.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>CABLAGE RESEAU STRUCTURE</h3>
                        <img src="images/Cablage.png" alt="Câblage Réseau Structuré">
                        <p>Installation de câblage réseau structuré.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>LIAISONS FIBRE OPTIQUE</h3>
                        <img src="images/optique.png" alt="Liaisons Fibre Optique">
                        <p>Connexions par fibre optique rapides.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>SECURITE PHYSIQUE</h3>
                        <img src="images/Securitep.png" alt="Sécurité Physique">
                        <p>Protection physique de vos installations.</p>
                    </a>
                    <a href="#" class="service-item">
                        <h3>PIECES DETACHEES AUTO</h3>
                        <img src="images/Auto.png" alt="Vente de piece Auto">
                        <p>Fourniture de piece detachées auto</p>
                    </a>
                </div>
            </section>
        </main>
