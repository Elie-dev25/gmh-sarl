                            ...
                            <article class="entry entry-grid text-center">
                                ...
                                <div class="entry-body">
                                    ...
                                    <h2 class="entry-title">
                                        <a href="single.html">Toute la gamme de verrerie de Laboratoire</a>
                                    </h2><!-- End .entry-title -->

                                    <div class="entry-content">
                                       <ul style=" list-style-type: disc;  text-align: left;">
                                        <p>Disponible chez GMH:</p>
                                        <p style="font-weight: bold;">La Verrerie Usuelle (de non précision):</p>
                                        <li>Tube à Essais</li>
                                        <li>Tube sous vide pour prélèvements sanguins (Vacutainer®, Terumo®, ...)</li>
                                        <li>Les Béchers</li>
                                        <li>Les Entonnoirs</li>
                                        <li>L‘Erlenmeyer</li>
                                        <li>Les Ballons</li>
                                        <li>Ampoule à décanter</li>
                                        <li>Le Cristallisoir</li>
                                        <li>Les Verres à Pied</li>
                                        <li>La Bonbonne à Eau </li>
                                        <li>La Pipette Pasteur</li>
                                        <p style="font-weight: bold;">La Verrerie de Précision ou Volumétrique:</p>
                                        <li>Éprouvette graduée</li>
                                        <li>Burette graduée (de Mohr)</li>
                                        <li>La Fiole jaugée</li>
                                        <li>Les Pipettes</li>
                        ...
                        <div class="entry-item lifestyle col-sm-6">
                            <article class="entry entry-grid text-center">
                                ...
                                <div class="entry-body">
                                    ...
                                    <h2 class="entry-title">
                                        <a href="single.html">-10°C ~-25°C Congélateur médical congélateur à basse température.</a>
                                    </h2><!-- End .entry-title -->
                        ...
                        <div class="entry-item lifestyle fashion col-sm-6">
                            <article class="entry entry-grid text-center">
                                ...
                                <div class="entry-body">
                                    ...
                                    <h2 class="entry-title">
                                        <a href="single.html">Toute la gamme des équipments de laboratoire disponible chez GMH</a>
                                    </h2><!-- End .entry-title -->
                                    <div class="entry-content">
                                        <p>Nous travaillons avec toutes les grandes Marques du domaine: <span style="font-weight: bold;">ESCO/ BIOBASE/ NUVE/ MEMMERT</span> et bien d’autres.</p>
                                    </div>
                                    <div class="entry-content">
                                       <ul style=" list-style-type: disc;  text-align: left;">
                                        <li>Poste de sécurite microbiologique</li>
                                        <li>Sorbonnes </li>
                                        <li>Hotte à Flux Laminaire</li>
                                        <li>Poste de travail/ Cabinet PCR</li>
                                        <li>Incubateur à CO2 </li>
                                        <li>Incubateur à convection Forcée</li>
                                        <li>Incubateur à Convection Naturelle</li>
                                        <li>Agitateurs magnetiques</li>
                                        <li>Agitateur</li>
                                        <li>PCR Thermocycleur </li>
                                        <li>Bain Marie</li>
                                        <li>Autoclaves</li>
                        ...
                        <div class="entry-item travel col-sm-6">
                            <article class="entry entry-grid text-center">
                                ...
                                <div class="entry-body">
                                    ...
                                    <h2 class="entry-title">
                                        <a href="single.html">La Verrerie spécialisée:</a>
                                    </h2><!-- End .entry-title -->
                                    ...
                                    <div class="entry-content">
                                       <ul style=" list-style-type: disc;  text-align: left;">
                                        <p style="font-weight: bold;">Les dessicateurs: <br>La Verrerie pour la Microbiologie:</p>
                                        <li>Lames de verre pour étalement et examen microscopique.</li>
                                        <li> Tubes et Flacons spéciaux pour cultures</li>
                                        <li>Boîtes de Pétri</li>
                            ...
                            <article class="entry entry-grid text-center">
                                ...
                                <div class="entry-body">
                                    <div class="entry-meta">
                                        ...
                                        <span class="meta-separator">|</span>
                                        <a href="#">Distributeur fiable</a>
                                    </div><!-- End .entry-meta -->

                                    <h2 class="entry-title">
                                        <a href="single.html">Materiel Médical</a>
                                    </h2><!-- End .entry-title -->

                                    <div class="entry-content">
                                        <p>GMH votre fournisseur fiable du matériel medical</p>
                                        </div>

                                    <div class="entry-content">
                                       <ul style=" list-style-type: disc;  text-align: left;">
                                        <li>Matériel de diagnostic. </li>
                                        <li>Équipement du cabinet (Table d’Examen, Tabouret de Médecin, etc…).</li>
                                        <li>Nécessaire d’examen / Petit Matériel (Boite de chirugie, Haricot inox, ciseaux médicaux, etc…).</li>
                                        <li>Désinfection & Protection (Masques de protection respiratoire, Blouse médicales, produits de nettoyage des mains, les Gants, etc…).</li>
                                        <li>Hypodermie (Toute la gamme d’Aiguilles, Séringues, etc…).</li>
                                        <li>Soins Pansements</li>
                                        <li>Matériel d’Urgence et de Secours (Défibrillateurs cardiaques, Pousse- Séringue, Electrodes de défibrillateurs et battéries, Matériel d’assistance respiratoire d’urgence, etc…)</li>
                                        <li>Matériel médical de maternité</li>
                                        <li>Matériel d’aide à l’autonomie</li>
                        ...
                        <div class="entry-item hobbies col-sm-6">
                            <article class="entry entry-grid text-center">
                                ...
                                <div class="entry-body">
                                    ...
                                    <h2 class="entry-title">
                                        <a href="single.html">GMH votre fournisseur fiable d’Équipment de Diagnostic</a>
                                    </h2><!-- End .entry-title -->

                                    <div class="entry-content">
                                        <ul style=" list-style-type: disc;  text-align: left;">
                                         <li>Appareil d’Hématologie ou Counter</li>
                                         <li>Appareil de Biochimie</li>
                                         <li>Coagulomètre</li>
                                         <li>Chaine Elisa & Kits Elisa</li>
                                         <li>Analyseur d’ Urine</li>
                                         <li>Glucomètre</li>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <li class="page-item active"><a style="color:#007bff;" class="page-link" href="cathalogue3.php">3</a></li>
